...
static yyconst short yy_nxt[][128] =
...

    {
        ...
        6,    6,    6,    6,    6,    6,    6,    6,   11,   12,
        6,    6,    6,    6,   13,    9,    9,    9,    9,    9,
...

    {
       ...
       16,   16,   16,   16,   16,   16,   16,   16,   21,   22,
       16,   16,   16,   16,   23,   19,   19,   19,   19,   19,
...

    {
       ...
       31,   31,   31,  -16,   31,   32,   31,   31
    },

    {
        5,   31,   31,   31,   31,   31,   31,   31,   31,   33,
       31,   31,   31,   31,   31,   31,   31,   31,   31,   31,
       31,   31,   31,   31,   31,   31,   31,   31,   31,   31,
...

    {
       ...
       31,   31,   31,   31,   31,   31,   31,   31,   31,   31,
       31,   31,   31,   31,   31,   31,   31,   31,   31,   31,
       31,   31,   31,   34,   34,   34,   31,   31,   34,   34,
       34,   34,   34,   34,   34,   34,   34,   34,   31,   31,
       31,   31,   31,   31,   31,   34,   34,   34,   34,   34,
       34,   34,   34,   34,   34,   34,   34,   34,   34,   34,

       34,   34,   34,   34,   34,   34,   34,   34,   34,   34,
       34,   31,   31,   31,   31,   34,   31,   34,   34,   34,
       34,   34,   34,   34,   34,   34,   34,   34,   34,   34,
       34,   34,   34,   34,   34,   34,   34,   34,   34,   34,
       34,   34,   34,  -34,   31,   32,   31,   31
    },
...
static yyconst short int yy_accept[43] =
    {   0,
       10,   10,   10,   10,   13,   11,   10,    9,    3,   11,
        5,    6,   11,    8,    7,   11,   10,    9,    3,   11,
        5,    6,   11,    7,    1,   10,    3,    3,    0,    4,
        0,    1,   10,    3,    3,    0,    4,    0,    2,    0,
        2,    1
    } ;
...
static yyconst yy_state_type yy_NUL_trans[43] =
    {   0,
       ...
       31,   31,   31,   31,   31,    0,    0,    0,   38,    0,
       31,   31,   31,   31,   31,   40,   31,   38,    0,   40,
       31,   40
    } ;
...
YY_RULE_SETUP
#line 49 "lexgram.l"
{yylval.string=strdup(yytext); yylval.string[strlen(yylval.string)-1]=NULL; BEGIN 0; return PUNCT; }
	YY_BREAK
case 2:
...
YY_RULE_SETUP
#line 51 "lexgram.l"
{yylval.string=strdup(yytext);	 return TOKEN;}
	YY_BREAK
case 4:
YY_RULE_SETUP
#line 52 "lexgram.l"
{yylval.number=atol(&yytext[1]); return WEIGHT;}
	YY_BREAK
case 5:
YY_RULE_SETUP
#line 53 "lexgram.l"
